    ...
    {showModal && (
        <div className="fixed block inset-0 flex items-center justify-center z-50 bg-teal-700 opacity-100 overflow-x-hidden overflow-y-auto">
          <div className="bg-gray-50 p-6 rounded-lg mx-8">
            ...
            <button 
            type="button" 
            className="text-gray-500 bg-gray-50 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600"
            onClick={closeModal}
            >
              Back
              </button>
